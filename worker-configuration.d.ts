/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0ddc5ff0a6bba9ca9087771e4e119198)
...
interface __BaseEnv_Env {
	...
	TELEGRAM_BOT_USERNAME: "TellboiBot";
	GITHUB_REPO: "MattieTK/tellboy";
	TellboyAgent: DurableObjectNamespace<import("./src/index").TellboyAgent>;
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	DEPLOYER: Service /* entrypoint TellboyDeployer from tellboy-deployer */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TellboyAgent" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_ID" | "AI_GATEWAY_ID" | "TELEGRAM_BOT_USERNAME" | "GITHUB_REPO">> {}
}
